...
void searchCateEx(Moneyfolio *mf[], int countEx);               // 지출 분류별 검색 기능
void searchCateIn(Moneyfolio *mf[], int countIn);               // 수입 분류별 검색 기능
void searchIncome(Moneyfolio *mf[], int countIn);               // 수입내역 검색 기능
void searchExpense(Moneyfolio *mf[], int countEx);              // 지출내역 검색 기능

void dayList(Moneyfolio *mf[]);                 // 일일 내역 list 기능
void monthList(Moneyfolio *mf[]);               // 월별 내역 list 기능
void sumList(Moneyfolio *mf[]);                 // 일별 내역 list + 합계 출력 기능
int save(Moneyfolio *mf[]);                     // 일별 내역 list +  합계 저장기능
